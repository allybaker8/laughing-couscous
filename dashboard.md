...
**Profile:** The settings page lets you change your name, updated your password, and add / remove user accounts (it  (i.e. name and password. Please note your email address will be your user name when logging into the application. Newly added users will receive an account activation email after being added to the system.

**Accounts:** Users can be assigned to several roles. Each role has different functionality within the application.

![Accounts](/img/usermanagement.png)

**Events:** This page lets you control the content and configuration of the event updates. The main toolbar includes tools to add new items, preview the update, split the event update into multiple pages, and save the edits made to the page. This tool also includes an optional email distribution list that will send event updates to email addresses you specify.

<img src="/img/EventToolTip.png" width="248" height="160" />

* **Event Items:** You may click on an existing event item or use the <img src="/img/1.png" width="20.5" height="18.5" /> button to add a new event item. Note when a new event item is added, it will appear at the the bottom of your page. To modify the event item, click edit in the top right corner of the event item you wish to update. Option buttons will appear along the right side of the event item in focus.  For each event item you may specify the title of the item, the data type,  and the item width. If necessary you can also delete an event item. 

After you've edited your event items, be sure to save your changes using <img src="/img/4.png" width="24.6" height="22.2" /> button from the main event toolbar.
